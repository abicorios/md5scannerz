...
if not exist md5scanerzgo start /wait cmd /c git clone https://github.com/abicorios/md5scanerzgo
if not exist md5scanerzgo.exe start /wait cmd /c go build md5scanerzgo\md5scanerzgo.go
